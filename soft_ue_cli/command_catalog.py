...
_EXPLICIT_ENTRIES: dict[str, dict[str, Any]] = {
    ...
    "rig": _entry(
        ...
        requires_bridge=True,
        requires_editor=True,
        required_plugins=[_plugin("Control Rig", "ControlRig", "Required to load Control Rig assets and read their hierarchy.")],
        examples=["soft-ue-cli rig inspect /Game/Characters/CR_Hero"],
    ),
    "rig inspect": _entry(
        "rig inspect",
        "Read a Control Rig hierarchy: bones, controls, nulls, curves, sockets, connectors, parents, and transforms.",
        layer="bridge",
        category="rig",
        requires_bridge=True,
        requires_editor=True,
    ...
    "rig control": _entry(
        ...
        requires_bridge=True,
        requires_editor=True,
        required_plugins=[_plugin("Control Rig", "ControlRig", "Required to load Control Rig assets and read control values.")],
        examples=["soft-ue-cli rig control get /Game/Characters/CR_Hero"],
    ),
    "rig control get": _entry(
        "rig control get",
        "Read Control Rig control values, typed per control (bool, float, vector, rotator, transform), current or initial.",
        layer="bridge",
        category="rig",
        requires_bridge=True,
        requires_editor=True,
        ...
        examples=[
            ...
            "soft-ue-cli rig control get /Game/Characters/CR_Hero --control hand_l_ctrl --value-type initial",
        ],
    ),
    "rig graph": _entry(
        "rig graph",
        ...
        requires_bridge=True,
        requires_editor=True,
        required_plugins=[_plugin("Control Rig", "RigVMDeveloper", "Required to read RigVM graph models on Control Rig assets.")],
        examples=["soft-ue-cli rig graph inspect /Game/Characters/CR_Hero"],
    ),
    "rig graph inspect": _entry(
        "rig graph inspect",
        "Read RigVM graph models on a Control Rig: nodes, pins, and links. Unlike `blueprint graph inspect`, this reads the RigVM model rather than the Blueprint EdGraph view.",
        layer="bridge",
        category="rig",
        requires_bridge=True,
        requires_editor=True,
    ...
    "niagara": _entry(
        "niagara",
        "Canonical Niagara inspection command family.",
        layer="bridge",
        category="niagara",
        requires_bridge=True,
        requires_editor=True,
        required_plugins=[_plugin("Niagara", "NiagaraEditor", "Required to read Niagara System module stacks.")],
        examples=["soft-ue-cli niagara system inspect /Game/FX/NS_Fire"],
    ),
    "niagara system": _entry(
        "niagara system",
    ...
    "niagara system inspect": _entry(
        "niagara system inspect",
        "Read a Niagara System the way its editor window presents it: emitters, the ordered module stack per script stage, renderers, and user-exposed parameters. Reads the asset, so no editor window has to be open.",
        layer="bridge",
        category="niagara",
        requires_bridge=True,
        requires_editor=True,
